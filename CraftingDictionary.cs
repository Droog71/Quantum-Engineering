...
public class CraftingDictionary
{
    ...
    public CraftingDictionary()
    {
        dictionary = new Dictionary<string, CraftingRecipe>
        {
            ...
            { "Logic AND", new CraftingRecipe(logicBlockIngredients, logicBlockAmounts, "Logic AND", 1) },
            { "Logic OR", new CraftingRecipe(logicBlockIngredients, logicBlockAmounts, "Logic OR", 1) },
            { "Logic XOR", new CraftingRecipe(logicBlockIngredients, logicBlockAmounts, "Logic XOR", 1) },
